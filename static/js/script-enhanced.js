...
const EVENT_THEMES = {
    'Birthday': [
        { name: 'Neon Energy', image: '/static/images/vibes/neon.jpg', value: 'Neon Energy' },
        { name: 'Modern Minimal', image: '/static/images/vibes/modern.jpg', value: 'Modern Minimal' },
        { name: 'Royal Luxury', image: '/static/images/vibes/royal.jpg', value: 'Royal Luxury' },
        { name: 'Floral Garden', image: '/static/images/vibes/floral.jpg', value: 'Floral Garden' }
    ],
    'Wedding': [
        { name: 'Royal Luxury', image: '/static/images/vibes/royal.jpg', value: 'Royal Luxury' },
        { name: 'Floral Garden', image: '/static/images/vibes/floral.jpg', value: 'Floral Garden' },
    ...
    function attachVibeListeners() {
        vibeSelector.querySelectorAll('.vibe-card').forEach(card => {
            card.addEventListener('click', () => {
                ...
                document.querySelectorAll('.vibe-card .glass-card').forEach(c => c.classList.remove('border-orange-500', 'ring-2', 'ring-orange-500/50'));
                
                // Add to clicked
                const innerCard = card.querySelector('.glass-card');
                innerCard.classList.add('border-orange-500', 'ring-2', 'ring-orange-500/50');
